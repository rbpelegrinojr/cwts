...
$resEmails = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM users_tbl WHERE email = '{$_REQUEST['email']}'"));
              ...
              <div class="card card-plain mt-8">
                ...
                <form action="verify_code.php?email=<?php echo $resEmails['email']; ?>" method="POST">
                  ...
                  if (isset($_REQUEST['btnCheckCode'])) {
                    ...
                    if ($code != '') {
                      $resCode = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM users_tbl WHERE email = '{$resEmails['email']}' AND code = '$code'"));
                    ...
                    if ($resCode['code'] == $code) {
                      ...
                      ?>
                        <div class="alert alert-warning" id="wrong_username_pass">
                          <center><label style="color: white;">Please Fill in Empty Fields</label></center>
                      </div>
                        <?php
                    }
