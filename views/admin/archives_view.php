	        ...
	        <div class="col-12">
	            <div class="page_title_box d-flex align-items-center justify-content-between">
	                <div class="page_title_left">
	                    <h3 class="f_s_30 f_w_700 text_white">ARCHIVES</h3>
	                    <ol class="breadcrumb page_bradcam mb-0">
	                    	<li class="breadcrumb-item"><a href="index">Dashboard </a></li>
	                    	<li class="breadcrumb-item active">Archived Reservations</li>
	                    </ol>
	                </div>
	            </div>
	        </div>
			...
			<div class="white_card card_height_100 mb_30">
				...
				<div class="white_card_body">
					...
					<?php
						...
						$query = mysqli_query($con, "SELECT * FROM reservations_tbl WHERE reservation_status = '5' ORDER BY reservation_id ASC");
									...
									<tr>
										...
										<td class="text-center">
											...
											if ($row['reservation_status'] == '0') {
												...
												echo "Completed";
											}elseif ($row['reservation_status'] == '5') {
												echo "Archived";
											}
											?>
										</td>
