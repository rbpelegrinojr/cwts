	        ...
	        <div class="col-12">
	            <div class="page_title_box d-flex align-items-center justify-content-between">
	                <div class="page_title_left">
	                    <h3 class="f_s_30 f_w_700 text_white">CANCELLED RESERVATIONS</h3>
			...
			<div class="white_card card_height_100 mb_30">
				...
				<div class="white_card_body">
					...
					<?php
						...
						$query = mysqli_query($con, "SELECT * FROM reservations_tbl WHERE reservation_status = '3' OR reservation_status = '2' ORDER BY date_created ASC");
							...
							<tbody>
								...
								while ($row = mysqli_fetch_assoc($query)) {
									...
									<tr>
										...
										<td class="text-center"><?php echo $row['disapproved_date']; ?></td>
