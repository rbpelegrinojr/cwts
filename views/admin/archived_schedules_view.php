            ...
            <div class="col-lg-12">
                <div class="white_card card_height_100 mb_30">
                    <div class="white_card_body">
                        <?php
                        $query = mysqli_query($con, "SELECT s.*, c.college_abbreviation, u.fname AS coord_fname, u.lname AS coord_lname
                            FROM schedules_tbl s
                            LEFT JOIN colleges c ON s.college_id = c.college_id
                            LEFT JOIN users_tbl u ON s.coordinator_id = u.user_id
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="text-center">
                                            <td><?php echo $i++; ?></td>
                                            <td><?php echo htmlspecialchars($row['coord_fname'] . ' ' . $row['coord_lname']); ?></td>
