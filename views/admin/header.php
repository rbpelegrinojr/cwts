...
<?php include '../../controller/admin/page_controller/sidebar.php'; ?>
...
<img style="height: 100px; width: 100px;" src="<?php echo $resSession['profile_image']; ?>" alt="#">
...
<a href="settings_view"><span class="fa fa-cog"></span> Settings</a>
<a href="header.php?btnLogout=1">Log Out </a>
</div>
</div>
</div>
</div>
