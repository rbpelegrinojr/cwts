...
<?php
$userRes = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM members_tbl WHERE member_id = '{$_REQUEST['m_id']}'"));
?>
          ...
          <div class="card card-profile shadow">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a >
                    <img src="<?php if(empty($userRes['profile_image'])){ echo '../../profile_images/empty.jpg'; }else{ echo $userRes['profile_image']; } ?>" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                <h3>
                  <?php echo $userRes['fname'].' '.$userRes['lname']; ?><span class="font-weight-light"></span>
                </h3>
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i><?php echo $userRes['role']; ?>
                </div>
                <div>
                  <i class="ni education_hat mr-2"></i><?php echo $userRes['contact_number']; ?>
                </div>
                <hr class="my-4">
              </div>
            </div>
          ...
          <div class="card bg-secondary shadow">
            <div class="card-header bg-white border-0">
              <div class="row align-items-center">
                <div class="col-8">
                  <h3 class="mb-0"><?php echo $userRes['fname']." ".$userRes['lname']; ?>'s account</h3>
                </div>
              ...
              <div>
                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" name="fname" class="form-control form-control-alternative" placeholder="First Name" value="<?php echo $userRes['fname']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Middle Name</label>
                        <input type="text" name="mname" class="form-control form-control-alternative" placeholder="Middle Name" value="<?php echo $userRes['mname']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Last Name</label>
                        <input type="text" name="lname" class="form-control form-control-alternative" value="<?php echo $userRes['lname']; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-first-name">Sext at Birth</label>
                        <select class="form-control" name="sex_at_birth" required="">
                          <option value="<?php echo $userRes['sex_at_birth']; ?>"><?php echo $userRes['sex_at_birth']; ?></option>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <select class="form-control" name="gender" required="">
                          <option value="<?php echo $userRes['gender']; ?>"><?php echo $userRes['gender']; ?></option>
                    ...
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <select class="form-control" name="role" required="">
                          <option value="<?php echo $userRes['role']; ?>"><?php echo $userRes['role']; ?></option>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" name="contact_number" class="form-control form-control-alternative" placeholder="First name" value="<?php echo $userRes['contact_number']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-first-name">Email</label>
                        <input type="email" name="email" class="form-control form-control-alternative" placeholder="First name" value="<?php echo $userRes['email']; ?>">
                      </div>
                    </div>
