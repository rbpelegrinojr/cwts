...
$id = $_REQUEST['id'];
$det = mysqli_fetch_assoc(mysqli_query($con, "SELECT * FROM members_tbl WHERE member_id = '$id'"));
?>
            ...
            <div class="col-12">
                <div class="page_title_box d-flex align-items-center justify-content-between">
                    <div class="page_title_left">
                        <h3 class="f_s_30 f_w_700 text_white">Attendance of <?php echo $det['fname'].' '.$det['lname']; ?></h3>
                        <ol class="breadcrumb page_bradcam mb-0">
                            <li class="breadcrumb-item"><a href="index">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="javascript:void(0);">Attendance of <?php echo $det['fname'].' '.$det['lname']; ?></a></li>
                        </ol>
                    </div>
