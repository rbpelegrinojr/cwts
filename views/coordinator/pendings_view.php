	        ...
	        <div class="col-12">
	            <div class="page_title_box d-flex align-items-center justify-content-between">
	                <div class="page_title_left">
	                    <h3 class="f_s_30 f_w_700 text_white">PENDING RESERVATIONS</h3>
			...
			<div class="white_card card_height_100 mb_30">
				...
				<div class="white_card_body">
					...
					<?php
						...
						$query = mysqli_query($con, "SELECT * FROM reservations_tbl WHERE reservation_status = '0' ORDER BY date_created ASC");
					...
					<div >
						<table class="table table-bordered" id="myTable">
							<thead>
								...
								<th class="text-center">Reservation Created</th>
							...
							<tbody>
								...
								while ($row = mysqli_fetch_assoc($query)) {
									...
									<tr>
										...
										<td class="text-center"><?php echo $resMem['fname'].' '.$resMem['lname']; ?></td>
										<td class="text-center"><?php echo $resType['reservation_type']; ?></td>
										<td class="text-center"><?php echo $row['reservation_description']; ?></td>
										<td class="text-center"><?php echo date('l F j, Y', strtotime($row['reservation_date'])).' @ '.date('h:i A', strtotime($row['reservation_time'])); ?></td>
										<td class="text-center"><?php echo $row['date_created']; ?></td>
										<!-- <td class="text-center"><?php echo $row['requirements']; ?></td> -->
										<td class="text-center">
											<div class="btn-group open">
											  <a class="btn btn-info btn-sm" href="#">Action</a>
											  <a class="btn btn-info btn-sm dropdown-toggle" data-toggle="dropdown" href="#">
											  </a>
											  <ul class="dropdown-menu">
											    <li><a href="#" onclick="approveRes(<?php echo $row['reservation_id']; ?>);"><i class="fa fa-check"></i> Approve</a></li>
											    <li><a href="#" onclick="cancelRes(<?php echo $row['reservation_id']; ?>);"><i class="fa fa-times"></i> Cancel</a></li>
											    <li><a href="disapprove_view.php?r_id=<?php echo $row['reservation_id']; ?>"><i class="fa fa-times"></i> Hold</a></li>
											    <!-- <li><a href="#" onclick="declineRes(<?php //echo $row['reservation_id']; ?>);"><i class="fa fa-times"></i> Disapprove</a></li> -->
											  </ul>
											</div>
										</td>
									</tr>
...
<script type="text/javascript">
	...
	function cancelRes(r_id) {
		if (confirm('Cancel Reservation?')) {
			window.location.href='../../controller/admin/process/save_data.php?btnCancel=1&r_id='+r_id+'&user_id=<?php echo $user_id; ?>';
		}
	}
</script>
<script type="text/javascript">
