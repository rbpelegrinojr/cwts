...
<p><?php echo date('Y'); ?> © <?php echo $resSettings['system_title']; ?> - Designed by <a href="#"> <i class="ti-heart"></i> </a><a href="#"> BSIT Students</a></p>
</div>
</div>
</div>
</div>
...
function autoSendSMS() {
  fetch('auto_send_sms.php')
    .then(response => response.text())
    .then(result => {
      console.log('SMS check:', result);
    })
    .catch(error => console.error('Error:', error));
}

// Run every 10 seconds
setInterval(autoSendSMS, 5000);
</script>
...
<script src="assets/metisMenu.js"></script>
...
<script src="assets/datepicker.custom.js"></script>
<script src="assets/chart.min.js"></script>
<script src="assets/roundedBar.min.js"></script>

<script src="assets/jquery.barfiller.js"></script>

<script src="assets/tagsinput.js"></script>

<script src="assets/summernote-bs4.js"></script>
<!-- <script src="assets/amcharts.js"></script> -->

<script src="assets/perfect-scrollbar.min.js"></script>
<script src="assets/scrollable-custom.js"></script>

<script src="assets/vectormap-2.0.2.min.js"></script>
<script src="assets/vectormap-world-mill-en.js"></script>
...
<script src='assets/list-main.js'></script>
<script src='assets/activation.js'></script> -->

<!-- <script src="assets/apex-chart2.js"></script> -->
<script src="assets/apex_dashboard.js"></script>
<!-- <script src="assets/echarts.min.js"></script> -->
<!-- <script src="assets/core.js"></script> -->
<!-- <script src="assets/charts.js"></script> -->
<script src="assets/animated.js"></script>
<script src="assets/kelly.js"></script>
<!-- <script src="assets/chart-custom.js"></script> -->

<script src="assets/dashboard_init.js"></script>
