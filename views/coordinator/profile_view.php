            ...
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a >
                    <img style="height: 180px;" src="<?php if(empty($resInfo['profile_image'])){ echo '../../profile_images/empty.jpg'; }else{ echo $resInfo['profile_image']; } ?>" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            ...
            <div class="card-body pt-0 pt-md-4">
              ...
              <div class="text-center">
                ...
                <div class="h5 font-weight-300">
                  <i class="ni location_pin mr-2"></i>Administrator
                </div>
                <div>
                  <i class="ni education_hat mr-2"></i><?php echo $resInfo['contact_number']; ?>
                </div>
                <hr class="my-4">
              </div>
            </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" name="fname" class="form-control form-control-alternative" placeholder="First Name" value="<?php echo $resInfo['fname']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="input-email">Last Name</label>
                        <input type="text" name="lname" class="form-control form-control-alternative" placeholder="Last Name" value="<?php echo $resInfo['lname']; ?>">
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        ...
                        <input type="text" name="contact_number" class="form-control form-control-alternative" placeholder="Contact Number" value="<?php echo $resInfo['contact_number']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-first-name">Email</label>
                        <input type="email" name="email" class="form-control form-control-alternative" placeholder="Email" value="<?php echo $resInfo['email']; ?>">
                      </div>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" readonly="" name="username" class="form-control form-control-alternative" placeholder="Username" value="<?php echo $resInfo['username']; ?>">
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Password</label>
                        <input type="password" name="password" class="form-control form-control-alternative" placeholder="Password" value="<?php echo $resInfo['password']; ?>">
                      </div>
                    </div>
                    <input type="hidden" name="user_id" value="<?php echo $resInfo['user_id'] ?>">
                    <div class="col-lg-4">
                      <div class="form-group focused">
