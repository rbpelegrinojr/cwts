              ...
              <div role="form text-left" action="controller/register.php" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="contact_number" placeholder="Contact Number" aria-label="Last Name" maxlength="12" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                  </div>
                </div>
                ...
                <div class="text-center">
                  <input type="submit" class="btn bg-gradient-dark w-100 my-4 mb-2" id="btnUserReg" value="Register">
                </div>
                <p class="text-sm mt-3 mb-0">Already have an account? <a href="../gad" class="text-dark font-weight-bolder">Sign in</a></p>
              </div>
            </div>
          </div>
        </div>
